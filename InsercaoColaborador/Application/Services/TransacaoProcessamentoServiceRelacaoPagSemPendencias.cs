...
{
    public class TransacaoProcessamentoServiceRelacaoPagSemPendencias : IProcessamentoService
    {
        ...
        public void Executar()
        {
            ...
            var transacaoExcel = ExcelService.ImportarExcel(caminhoExcel, "RELACAO PAG SEM PENDENCIAS", linha =>
            {
            ...
            var transacoes = transacaoExcel.Select(e =>
            {
                ...
                return new Transacao
                {
                    ...
                    ObservacoesEntidade = string.Concat("2.", e.Item),
